 ...
 * @since 1.0 2017/2/10
 **/
public interface BasicRecyclerViewAdapterFunction<SourceType> {
     ...
     * @param data     数据集
     */
    void add(int position, List<SourceType> data);
     ...
     */
    List<SourceType> change(int position, List<SourceType> data);
