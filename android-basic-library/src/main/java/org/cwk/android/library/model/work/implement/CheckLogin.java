...
import org.cwk.android.library.model.data.implement.LoginData;
...
public class CheckLogin extends DefaultWorkModel<String, String, LoginData> {
    ...
    protected String onTaskUri() {
        return ApplicationAttribute.getLoginUrl();
    }
    ...
    protected void onFinish() {
        // 发送广播
        BroadcastUtil.sendBroadcast(Global.getContext(), ApplicationStaticValue.BroadcastAction
                .LOGIN_STATE);
    }
}
